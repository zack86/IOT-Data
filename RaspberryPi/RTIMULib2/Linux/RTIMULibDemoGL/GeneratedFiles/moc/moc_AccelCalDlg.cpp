...
struct qt_meta_stringdata_AccelCalDlg_t {
    QByteArrayData data[10];
    char stringdata[86];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_AccelCalDlg_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AccelCalDlg_t qt_meta_stringdata_AccelCalDlg = {
    {
...
const QMetaObject AccelCalDlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_AccelCalDlg.data,
      qt_meta_data_AccelCalDlg,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AccelCalDlg.stringdata))
