...
struct qt_meta_stringdata_SelectFusionDlg_t {
    QByteArrayData data[4];
    char stringdata[31];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SelectFusionDlg_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SelectFusionDlg_t qt_meta_stringdata_SelectFusionDlg = {
    {
...
QT_MOC_LITERAL(3, 22, 8)
    ...
    "SelectFusionDlg\0onOk\0\0onCancel"
};
...
const QMetaObject SelectFusionDlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SelectFusionDlg.data,
      qt_meta_data_SelectFusionDlg,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SelectFusionDlg.stringdata))
